...
from sklearn import model_selection, preprocessing, linear_model #機械学習用のライブラリを利用
import sklearn
sklearn.__version__
...
X_rm_train, X_rm_test, Y_train, Y_test = model_selection.train_test_split(X_rm, Y, test_size=0.2, random_state=0)
