...
df = pd.read_csv('./data/class/iris.csv')
#データの抽出
...
X_combined_std = np.vstack((max_train_std, max_test_std))
y_combined = np.hstack((max_train, max_test))

fig = plt.figure(figsize=(13,8))
plot_decision_regions(X_combined_std, y_combined, clf=max_model,  res=0.02)
plt.show()
